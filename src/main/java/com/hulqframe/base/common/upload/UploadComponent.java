...
import com.hulqframe.utils.ControllerUtil;
import com.hulqframe.utils.PathUtil;
...
public class UploadComponent {
    ...
    public UploadBean uploadFile(MultipartFile multipartFile, HttpServletRequest request){
        ...
        User userVo  = null;
        if(userVo!=null) {
            attachment.setUserId(userVo.getId());
        ...
        if (!multipartFile.isEmpty()) {
            ...
            try {
                ...
                result.setFileId(attachment.getId());
                result.setFileName(attachment.getOriginalFilename());
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public  String getZipFileName(String fileName){
        ...
        return File.separator + "upload" + File.separator +"ebook"+File.separator + year
                + File.separator + month+ File.separator + dom+ File.separator + fileName;
    }
    ...
    public  String getNewFileName(String fileName){
        ...
        int year = cal.get(Calendar.YEAR);
        int dom = cal.get(Calendar.DAY_OF_MONTH);
        return File.separator + "upload" + File.separator + year
                + File.separator + month + File.separator + dom + File.separator + fileName;
    }
    ...
    public  String getEbookFileFolder(){
        ...
        int dom = cal.get(Calendar.DAY_OF_MONTH);
        return File.separator + "upload" + File.separator +"ebook" + File.separator + year
                + File.separator +month + File.separator + dom;
    }
